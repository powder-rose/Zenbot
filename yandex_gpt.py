...
Не используй HTML.
Сам заголовок возвращай обычным текстом без символов форматирования: жирное начертание применит код публикации.
Категорически запрещено использовать символ звёздочки * вообще
в любом месте текста.

Для списков используй только символ •.
Каждый пункт списка ОБЯЗАТЕЛЬНО начинай с новой строки.
Никогда не размещай два или более пунктов списка в одной строке.
...
ЗАГОЛОВОК: <один обычный заголовок без эмодзи; при публикации он будет оформлен жирным кодом>
